...
#else
#define ION_RESERVE_SIZE	FB_MAXPGSIZE*3+1
#endif

#else

#define FB_MAXPGSIZE		get_fb_size()
...
#endif
#ifdef CONFIG_FB_ROCKCHIP
	resource_fb[0].start = board_mem_reserve_add("fb0 buf", FB_MAXPGSIZE);
	resource_fb[0].end = resource_fb[0].start + FB_MAXPGSIZE- 1;
#if 0
